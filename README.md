...
Getting Started
Download the distribution code from https://cdn.cs50.net/ai/2020/spring/projects/0/degrees.zip and unzip it.
Understanding
...
You should not modify anything else in the file other than the shortest_path function, though you may write additional functions and/or import other Python standard library modules. You should not import any third-party Python libraries for this project.
...
submit50 ai50/projects/2020/fall/degrees
Acknowledgements
